  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        criteria:
          "present if the document states integrated/built-in or freestanding for at least one named appliance ('integrated dishwasher', 'freestanding range cooker', 'built-under double oven'). AMBIGUOUS: the distinction gestured at without a stated answer — 'we'll confirm integrated or freestanding later', 'appliance type TBC'. NEAR-MISS = ABSENT: an appliance list with no integrated/freestanding wording at all — absent, not ambiguous. Silence is absent.",
      },
      {
