  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        criteria:
          "present if the document names an actual internal preparation activity — PVA/bonding agent applied, sealing high-suction backgrounds, dubbing out hollows, raking out and filling cracks, removing loose material, applying a bonding primer such as Thistle Bond-it, or scrim taping joints. AMBIGUOUS: preparation asserted with no activity named ('walls will be properly prepared', 'prep included'). NEAR-MISS = ABSENT: 'we do a proper job', 'we never cut corners', 'everything done right' name no preparation activity — absent, not ambiguous. NO-REUSE: EXTERNAL background preparation (washing down brickwork, fungicidal wash, applying a render key coat) may NEVER evidence this internal field. Silence is absent.",
      },
      {
        ...
        criteria:
          "present if the document names the actual corner/edge treatment — galvanised or stainless angle beads, thin-coat beads, stop beads, arch beads, plasterboard scrim tape to joints, or a stated treatment of reveals and window returns. AMBIGUOUS: edges referenced with no treatment named ('corners will be neat and square', 'sharp edges throughout'). NEAR-MISS = ABSENT: 'a tidy finish', 'straight walls', 'no wonky corners' name no bead, tape or reveal treatment — absent, not ambiguous. NO-REUSE: EXTERNAL beading (render stop beads, bellcast drip beads) may NEVER evidence this internal field — that belongs to movement_joints_and_beading_external. Silence is absent.",
      },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        criteria:
          "present if the document names an actual external preparation activity — jet/wash down of the substrate, fungicidal or biocidal wash, hacking off defective render, raking out and repointing, applying a primer/stabiliser or a base/key coat, or fixing reinforcing mesh to the background. AMBIGUOUS: preparation asserted with no activity named ('walls prepared before rendering', 'prep included'). NEAR-MISS = ABSENT: 'we do it properly', 'no shortcuts on the outside' name no preparation activity — absent, not ambiguous. NO-REUSE: INTERNAL preparation (PVA, scrim tape, dubbing out) may NEVER evidence this external field. Silence is absent.",
      },
      {
    ...
    fields: [
      {
        ...
        criteria:
          "present if the document names the actual protection measures — dust sheets, correx or hardboard floor protection, masking of windows and frames, polythene sheeting to doorways, dust barriers, or covering paths, patios, planting and vehicles outside. AMBIGUOUS: protection asserted with nothing named ('everything will be protected', 'we take care of your property'). NEAR-MISS = ABSENT: 'clean and tidy workers', 'we respect your home', 'you won't know we've been' name no protection measure — absent, not ambiguous. Silence is absent.",
      },
      {
      ...
      },
      {
        ...
        criteria:
          "EITHER/OR FIELD — present if the document states EITHER that waste/debris is removed from site (skip provided, waste taken away, rubble removed) OR that the areas are cleaned down on completion (swept, vacuumed, floors washed off). Explicit exclusion ('customer to provide skip', 'waste left in the garden for your disposal') is ALSO present — it is a stated scope decision. AMBIGUOUS: cleanup implied with nothing stated about waste or cleaning ('we finish up at the end of each day'). NEAR-MISS = ABSENT: 'we leave the place tidy', 'we'll sort the mess out', 'clean and respectful tradesmen' name neither waste removal nor a cleaning activity — absent, not ambiguous. Silence is absent.",
      },
    ],
  },
  {
