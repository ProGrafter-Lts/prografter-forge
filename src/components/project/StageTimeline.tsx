...
import { CheckCircle2, Circle, Image, Upload, X, Users } from "lucide-react";
...
const StageTimeline = ({ stages, updates, userRole, userId, onRefresh, onAssignSub }: StageTimelineProps) => {
                      ...
                      {userRole === "trade" && isActive && (
                        <div className="mt-3 border-t border-navy/5 pt-3">
                          ...
                          <div className="flex items-center justify-between mt-2">
                            ...
                            <button onClick={submitUpdate} disabled={submitting || !updateText.trim()}
