const features = [
  ...
  { num: "05", title: "Fair Pricing Model", desc: "No subscription to join, quote, or get paid — ever. Optional paid tools are separate add-ons. Commission is capped at £900 per job." },
