...
const FOOTER_GROUPS = [
  { title: "Homeowners", links: [["Project Cost Guide", "/project-cost-guide"], ["Quote Checker", "/quote-checker"], ["How It Works", "/how-it-works"], ["Our Checks", "/trade-verification#our-checks"]] },
  { title: "ProGrafter", links: [["Platform Tour", "/platform-tour#live-now"], ["Trust Centre", "/trust"], ["Advice", "/resources"], ["About", "/about"]] },
  { title: "For Trades", links: [["Join as a Trade", "/signup/trade"], ["Pricing", "/pricing#marketplace-pricing"], ["Planning Alerts", "/planning-intelligence"], ["Calculators", "/calculators"]] },
];
