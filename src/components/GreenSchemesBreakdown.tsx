...
const SCHEMES: Scheme[] = [
  {
    ...
    note: "A PAS 2035 Retrofit Coordinator must assess the property first. ProGrafter has certified Retrofit Coordinators and EWI installers on the platform.",
    badge: "green",
  ...
  },
  {
    ...
    note: "All ProGrafter heat pump installers are MCS-certified — verified before they appear on the platform.",
    badge: "teal",
  ...
  },
  {
    ...
    oneLiner:
      "Up to £10,000 for homes off the gas grid that need heating and insulation improvements.",
    whatItIs:
      "Designed specifically for properties that cannot connect to mains gas — typically rural homes using oil, LPG, or electric heating. Administered by local councils using central government funding. Availability varies by area.",
    qualifies: [
      "Owner-occupier OR private tenant (with landlord consent)",
      "Property is off the gas grid (no mains gas supply)",
      "EPC band D, E, F, or G — income threshold may apply depending on local authority",
    ],
    paysFor:
      "Heat pumps, solar panels, loft insulation, wall insulation, heating controls, double glazing",
    maxValue: "Up to £10,000",
    note: "Check with your local council — each area runs its own HUG2 scheme and availability varies by postcode.",
    badge: "amber",
  ...
  },
  {
    ...
    note: "All ProGrafter EV charger installers are OZEV approved — required to access this grant.",
    badge: "teal",
