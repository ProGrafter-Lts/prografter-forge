...
const GENERAL = [
  ...
  { q: "Is ProGrafter free to use?", a: "It's free to register and free to post a job. Trades pay a 7.5% commission only on completed, paid jobs, capped at £900. Homeowners can use the free Project Cost Guide, with a paid Quote Health Check available for detailed reviews." },
];
