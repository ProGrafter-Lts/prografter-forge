...
const GENERAL: Faq[] = [
  ...
  { q: "How is ProGrafter different from lead-selling platforms?", a: "ProGrafter verifies trades, records homeowner contact and project details, reviews every brief by hand and charges only after completed, paid work.", link: { label: "Compare the pricing models", href: "/pricing" } },
