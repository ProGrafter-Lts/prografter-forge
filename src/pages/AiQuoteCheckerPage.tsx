...
const FAQ = [
  ...
  { q: "How much does it cost?", a: "There's a free Project Cost Guide tool for early planning, and a paid Quote Checker for a detailed review of a specific quotation. See the ProGrafter Intelligence page for current options." },
