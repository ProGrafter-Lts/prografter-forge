      ...
      return (
        <div className="text-center py-16 space-y-5">
          ...
          <p className="font-mono text-sm text-muted-foreground max-w-md mx-auto leading-relaxed">
            ...
            reviewing it by hand to make sure your AI Quote Checker report is accurate.
    ...
    if (fallbackReason && !report) {
      ...
      return (
        <div className="text-center py-16 space-y-5">
          ...
          <p className="font-mono text-sm text-muted-foreground max-w-md mx-auto leading-relaxed">
            {isTimeout
              ? "Your AI Quote Checker report is still being prepared. Give it a moment, then reload to check again. We've also emailed you a secure link to your report."
              : "Your AI Quote Checker report has finished processing. Reload to open it. We've also emailed you a secure link to your report."}
          </p>
          <button
            type="button"
    ...
    if (!report) {
      return (
        <div className="text-center py-16 space-y-4">
          ...
          <h2 className="font-heading text-2xl text-navy">Preparing your AI Quote Checker report…</h2>
          <p className="font-mono text-sm text-muted-foreground max-w-md mx-auto leading-relaxed">
            Your report is being prepared. This usually takes a few minutes.
          </p>
        </div>
      );
    }
  ...
  return (
    <AppShell>
      <div className="min-h-screen bg-background">
        <SEO
          title="Your AI Quote Checker Report — ProGrafter"
        ...
        <div className="pt-24 pb-16 px-6">
          <div className="max-w-2xl mx-auto qr-print-area">
            <div className="text-center mb-8">
              ...
              <h1 className="font-heading text-3xl md:text-4xl text-navy">Your AI Quote Checker Report</h1>
            </div>
            {renderBody()}
          </div>
        </div>
