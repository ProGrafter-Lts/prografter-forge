...
const FAQ = [
  ...
  { q: "How much does it cost homeowners?", a: "Homeowners post jobs for free and are matched with verified trades at no cost. The AI Quote Checker offers a free Project Cost Guide, with a paid AI Quote Checker report for detailed reviews of a specific quote." },
