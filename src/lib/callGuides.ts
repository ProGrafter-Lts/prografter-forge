...
export const CALL_TYPES: { value: string; label: string; sections: string[] }[] = [
  ...
  { value: "qhc_followup", label: "Quote Health Check follow-up", sections: ["opening", "concern", "quotes", "budget", "trade", "feedback", "next_steps"] },
...
export const SECTIONS: Record<string, GuideSection> = {
  ...
  blockers: {
    ...
    questions: [
      ...
      "Would you like to run a Quote Health Check?",
    ],
    fields: [
  ...
  feedback: {
    ...
    questions: [
      "Was the Quote Health Check useful?",
