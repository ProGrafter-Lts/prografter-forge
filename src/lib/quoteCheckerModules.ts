...
export const QUOTE_CHECKER_MODULES: QuoteCheckerModule[] = [
  ...
  },
  {
    ...
    display_name: "Boiler / Heating Quote Checker Module",
    short_label: "Boiler / heating",
    status: "coming_soon",
    description: "Boiler replacements, heating systems and radiator works.",
    route_or_component: null,
    supported_project_types: ["boiler replacement", "heating", "radiators"],
    scoring_categories: [],
    homeowner_questions: [],
